  ...
  <div>
    ...
    <div class="article-container">
      ...
      <van-cell center :title="artObj.aut_name" :label="formatDate(artObj.pubdate)">
        ...
        <template #default>
          <div>
            <van-button type="info" size="mini" v-if="artObj.is_followed === true" @click="followedFn(true)">已关注
            </van-button>
      ...
      <div class="like-box">
        <van-button icon="good-job" type="danger" size="small" v-if="artObj.attitude === 1" @click="loveFn(true)">已点赞
        </van-button>
